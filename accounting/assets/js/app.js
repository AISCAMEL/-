...
A.app = (function () {
  ...
  const NAV = [
    ...
    { path: 'import', label: '銀行明細取込', icon: '🏦' },
    { path: 'invoices', label: '請求書', icon: '📄' },
    { path: 'estimates', label: '見積書', icon: '📝' },
    { path: 'recurring', label: '定期請求', icon: '🔁' },
