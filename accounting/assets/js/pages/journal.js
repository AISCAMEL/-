...
(function () {
  ...
  const SRC_LABEL = { invoice: '請求', expense: '入出金', import: '取込', depreciation: '減価償却', disposal: '除却売却', lease: 'リース', compression: '圧縮', inventory: '棚卸', opening: '期首', closing: '決算', payroll: '給与', manual: '手入力' };
