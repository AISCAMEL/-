...
import { AliExpressConnector } from "./aliexpress/aliexpress-connector.js";
import { BaseConnector } from "./base/base-connector.js";
import { AmazonConnector } from "./research/amazon-connector.js";
import { EbayConnector } from "./research/ebay-connector.js";
import { RakutenConnector } from "./research/rakuten-connector.js";
import { YahooConnector } from "./research/yahoo-connector.js";
...
export function createSupplierConnectors(
  ...
  return {
    ...
    aliexpress: new AliExpressConnector(configFor(config, "aliexpress")),
  };
}
...
export function createMarketConnectors(
  ...
  return {
    ...
    yahoo: new YahooConnector(configFor(config, "yahoo")),
    ebay: new EbayConnector(configFor(config, "ebay")),
  };
}
