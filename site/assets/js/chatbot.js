  ...
  var KB = {
    user: {
      ...
      rules: [
        ...
        { k: ['時間', '受付', '電話', '連絡', '何時'], a: 'お電話の受付は平日8:00〜17:00、フォームは24時間受付です。📞 050-1722-3365' }
      ],
      fallback: 'お力になれずすみません。ページ上部の査定シミュレーション、無料査定フォーム（buymo-contact.html）、またはお電話（050-1722-3365／平日8:00〜17:00）で詳しくご案内します。'
    },
    partner: {
      title: '加盟店サポート',
