...
function sendApplicantThankYou_(cfg, rec) {
  ...
  // 審査結果のご案内（会員ページ経由。URL設定後は自動でログインリンクを表示）
  var resultBlock = cfg.MYPAGE_URL
    ? '審査の結果は、最短で当日〜3営業日以内に「会員ページ」にてご案内いたします。\n' +
      '下記より会員ページにログインのうえ、ご確認ください。\n\n' +
      '  ▼ 会員ページにログイン\n' +
      '  ' + cfg.MYPAGE_URL + '\n'
    : '審査の結果は、最短で当日〜3営業日以内に「会員ページ」にてご案内いたします。\n' +
      'ログイン用のご案内は、準備が整いしだい、あらためて当社よりお送りいたします。\n' +
      'いましばらくお待ちくださいませ。\n';
  ...
  var body =
    ...
    'ご入力いただいた内容をもとに、担当スタッフが審査を進めてまいります。\n\n' +
    '━━━━━━━━━━━━━━━━━━━━━━\n' +
    '  これからの流れ\n' +
    '━━━━━━━━━━━━━━━━━━━━━━\n\n' +
    '  【1】審査の受付（完了）\n' +
    ...
    '  【3】審査結果のご案内\n' +
    resultBlock + '\n' +
    '審査を進めるうえで追加の書類などが必要な場合は、\n' +
    'あらためて担当者よりご案内いたします。\n\n' +
    'ご不明な点やお急ぎのご相談は、LINEまたはお電話にて\n' +
    'お気軽にお問い合わせください。\n\n' +
