    ...
    <LegalShell title="特定商取引法に基づく表記">
      <table className="w-full border-collapse text-sm">
        <tbody>
          ...
          <Row label="販売価格">
            各料金プランに表示の金額（受付プラン 月額3,980円／営業プラン 月額6,980円／統合プラン 月額12,800円、いずれも税込）。
            上記の基本料に加え、着信対応料（1件あたり20〜30円）・通話料（1分あたり20〜30円）が従量で加算されます。
            電話番号の種類（市外局番・フリーダイヤル等）や追加番号は別途オプション料金が加算されます。
          </Row>
