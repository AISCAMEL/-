...
function ais_recruit_positions() {
	return array(
		...
		array(
			...
			'brand'   => 'カーメル / CARSHICO',
			'icon'    => 'car',
			'summary' => '自動車販売「カーメル」やオンライン車販売「CARSHICO」で、お客様へのご提案・接客・納車までをサポートするスタッフを募集します。',
			'points'  => array( 'クルマのご提案・接客・販売サポート', 'オンライン販売の問い合わせ対応', '乗り換え・買取の橋渡し', 'クルマ好き歓迎・未経験可' ),
			'welcome' => 'クルマや接客が好きな方／お客様の「困った」に寄り添える方',
		),
		array(
			'title'   => 'カスタマーサポート／AIオペレーター運用',
			'type'    => '正社員・アルバイト',
			'brand'   => 'AIオペレーター24',
			'icon'    => 'app',
			'summary' => 'お問い合わせ・チャット対応や、AI電話応対「AIオペレーター24」の運用・改善を担うメンバーを募集します。',
			'points'  => array( '問い合わせ・チャットの一次対応', 'AIオペレーターの運用・チューニング補助', 'お客様の声を社内にフィードバック', '丁寧なコミュニケーションを重視' ),
			'welcome' => '丁寧な対応が得意な方／新しいツールの活用に前向きな方',
		),
	);
}
