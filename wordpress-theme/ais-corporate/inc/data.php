...
function ais_site() {
	return array(
		...
		// 代表者名（ここを変更すると、会社概要・代表メッセージ等に一括反映されます）
		'ceo'          => '吉田 一平',
...
function ais_company_profile() {
	...
	return array(
		...
		array( 'label' => '代表者', 'value' => '代表 ' . $site['ceo'] ),
...
function ais_representative() {
	...
	return array(
		...
		'lead'    => 'ごあいさつ',
		'body'    => array(
			'このたびは、合同会社アイズのウェブサイトをご覧いただき、誠にありがとうございます。代表の' . $site['ceo'] . 'です。',
			'私たちアイズは、自動車の販売・買取・オンライン納車・車両セキュリティ・レッカーといったクルマに関わる事業を主軸に、ノーコードアプリ開発やサブスク型のWeb制作、フランチャイズ事業まで幅広く手がけています。掲げているのは「Always Innovation Solutions＝常に、新しい解決策を」という言葉。クルマのことからデジタルの活用まで、お客様の「困った」「こうしたい」にワンストップでお応えすることを、何より大切にしています。',
			'いま、自動車業界はクルマの「買い方」も「持ち方」も大きく変わろうとしています。私たちはこの変化を「リスク」ではなく「成長の機会」だと捉えています。新しい仕組みや技術を積極的に取り入れながら、いわきの地から、地域とお客様に寄り添い続ける——それが私たちの基本姿勢です。',
			'そして私たちは、商品やサービスをお渡しして終わりにはしません。ご相談の入口から、実行、そしてその先の成果まで、最後まで伴走するパートナーでありたいと願っています。',
			'「何から始めればいいか分からない」という段階でも構いません。お問い合わせフォーム・メール、そしてこのサイトのAIチャットから、どうぞお気軽にお声がけください。皆さまとお会いできることを、心より楽しみにしています。',
		),
	);
}
...
function ais_philosophy() {
	return array(
		...
		'tagline' => '常に、新しい解決策を。',
		// 理念体系（パーパス→ミッション→ビジョン）
		'purpose' => '変化を、お客様と地域の“成長の機会”に。',
		'mission' => 'クルマからデジタルまで、「困った」「こうしたい」にワンストップで応え、構想から成果まで最後まで伴走する。',
		'vision'  => 'いわきから、暮らしと事業の“次の便利”をつくり続ける。',
		'belief'  => array(
			'title' => '私たちの想い',
			'body'  => array(
				'テクノロジーと社会は、かつてない速さで変化しています。とりわけ自動車業界は、クルマの「買い方」「持ち方」「守り方」までもが大きく変わろうとしています。',
				'私たちアイズは、その変化を「リスク」ではなく「成長の機会」と捉えます。販売・買取・オンライン納車・車両セキュリティから、アプリ・Web開発まで——領域を越えて新しい解決策を組み合わせ、お客様の「困った」「こうしたい」に応えていきます。',
				'大切にしているのは、お渡しして終わりにしないこと。構想から実行、その先の成果まで、いわきの地から最後まで伴走する。それが、私たちの変わらない姿勢です。',
			),
		),
		'values'  => array(
			array( 'title' => '革新 / Innovation', 'body' => '現状維持に満足せず、新しい技術と発想を取り入れ続ける。変化を、お客様が前へ進む力に変えます。' ),
			array( 'title' => '品質 / Quality', 'body' => '戦略から実行まで一つひとつの仕事に責任を持ち、「任せてよかった」と思える確かさで成果に向き合います。' ),
			array( 'title' => '信頼性 / Reliability', 'body' => '誠実な対応と、お渡しして終わりにしない伴走で、長く頼っていただける関係を築きます。' ),
		),
	);
}

/** 採用：募集職種（※待遇等の詳細は応相談／確定情報に差し替え可） */
function ais_recruit_positions() {
	return array(
		array(
			'title'   => '車買取 業務委託パートナー',
			'type'    => '業務委託',
			'brand'   => 'BUYMO',
			'icon'    => 'tag',
			'summary' => '買取ブランド「BUYMO」のスキームを活用し、クルマ・トラック・農機具・アルミなどの買取を担う業務委託パートナーを募集します。ご自身のペースで、副業・兼業からでも始められます。',
			'points'  => array( '成果に応じた報酬の業務委託', '全国対応の買取スキームを活用', '未経験でも本部がノウハウを提供', '副業・兼業・独立開業の足がかりに' ),
			'welcome' => '自動車・買取ビジネスに関心がある方／人と接することが得意な方／将来的に独立を目指す方',
		),
		array(
			'title'   => 'クリエイター（アプリ・Web制作）',
			'type'    => '正社員・業務委託',
			'brand'   => 'APPREX / WEB crews',
			'icon'    => 'code',
			'summary' => 'ノーコードアプリ開発「APPREX」やサブスクWeb制作「WEB crews」で、企画・制作・運用までを担うクリエイターを募集します。アイデアを形にし、公開後の改善まで伴走します。',
			'points'  => array( 'アプリ／Webサイトの企画・制作・運用', 'ノーコード中心でスピードと提案を重視', 'デザイン〜実装〜改善まで幅広く', 'リモート・働き方は応相談' ),
			'welcome' => 'Web／アプリ制作の経験者、または学習中の方／デザインやコーディングが好きな方／提案・改善まで踏み込みたい方',
		),
	);
}
...
/**
 * 実績・事例（イメージ事例）。
 * ※ 内容は構成イメージ用に作成した事例です。実案件が出たら差し替えてください。
 */
function ais_works() {
	return array(
		array(
			'slug' => 'carmel-buymo-replace', 'category' => 'mobility', 'category_label' => '自動車販売・買取',
			'title' => '中古車のご提案と買取を組み合わせ、予算内での乗り換えを実現',
			'summary' => 'ご予算・ご用途をうかがい最適な中古車をご提案（カーメル）。今お乗りの車の買取（BUYMO）と組み合わせ、月々の負担を抑えた乗り換えを実現しました。',
			'result' => '下取り込みでご希望予算内の乗り換えを実現',
			'is_placeholder' => false,
			'detail' => array(
				array( 'h' => '背景・ご相談内容', 't' => '「家族が増えたので、もう少し大きい車に乗り換えたい。ただ予算は抑えたい」とご相談をいただきました。' ),
				array( 'h' => '課題', 't' => 'ご希望の車種と予算に開きがあり、今お乗りの車の売却額も乗り換え計画に大きく影響する状況でした。' ),
				array( 'h' => 'アイズの支援内容', 't' => 'ご用途に合う中古車を複数ご提案（カーメル）。あわせて現在の車をBUYMOで査定し、下取りとして組み込むことで総額を圧縮しました。' ),
				array( 'h' => '成果', 't' => '買取額を頭金に充てることで、ご希望の予算内で乗り換えが完了。販売から買取・名義変更まで窓口を一本化し、手間も最小限に。' ),
			),
		),
		array(
			'slug' => 'carshico-remote-delivery', 'category' => 'mobility', 'category_label' => 'オンライン車販売',
			'title' => '来店ゼロ。遠方のお客様へ新車をオンライン販売・自宅納車',
			'summary' => '店舗まで距離があり来店が難しいお客様へ、新車をオンラインで注文（CARSHICO）。手続きまでオンラインで完結し、ご自宅まで納車しました。',
			'result' => '来店不要で新車購入から納車まで完結',
			'is_placeholder' => false,
			'detail' => array(
				array( 'h' => '背景・ご相談内容', 't' => '「近くに希望の販売店がなく、仕事も忙しい。できれば来店せずに新車を買いたい」とのご要望でした。' ),
				array( 'h' => '課題', 't' => '車種選定・見積り・契約・納車までを、来店せずに不安なく進められる体制が必要でした。' ),
				array( 'h' => 'アイズの支援内容', 't' => 'CARSHICOでオンライン見積り・ご提案を実施。手続きをオンラインで進め、ご自宅への納車を手配しました。' ),
				array( 'h' => '成果', 't' => '一度も来店することなく、新車のご購入から納車まで完了。移動時間の負担なく、ご希望の一台をお届けできました。' ),
			),
		),
		array(
			'slug' => 'tengo-fleet-security', 'category' => 'mobility', 'category_label' => '車両セキュリティ',
			'title' => '社用車への GPS 遠隔停止システム導入で、車両管理を強化',
			'summary' => '複数の社用車を保有する事業者様へ、車両セキュリティ「天護（TENGO）」を導入。位置把握と遠隔エンジン停止で、盗難・不正利用への備えを整えました。',
			'result' => '車両の所在を常時把握し、盗難リスクを低減',
			'is_placeholder' => false,
			'detail' => array(
				array( 'h' => '背景・ご相談内容', 't' => '「社用車が増えてきたが、稼働状況や所在の把握が難しい。盗難も心配」とご相談をいただきました。' ),
				array( 'h' => '課題', 't' => '複数台の車両について、所在の把握と、万一の盗難・不正利用時のリスク低減策が求められました。' ),
				array( 'h' => 'アイズの支援内容', 't' => '各車両に天護（TENGO）を導入。GPSによる位置把握と、万一の際の遠隔エンジン停止を設定しました。' ),
				array( 'h' => '成果', 't' => '車両の所在を常時把握できる体制を構築。盗難・不正利用への抑止力となり、車両管理の安心感が向上しました。' ),
			),
		),
		array(
			'slug' => 'apprex-reservation-app', 'category' => 'it', 'category_label' => 'IT事業（APPREX）',
			'title' => 'ノーコードで予約管理アプリを短期開発・リリース',
			'summary' => '紙と電話で管理していた予約業務を、ノーコードアプリ開発「APPREX」でアプリ化。企画からリリースまでをスピーディに対応しました。',
			'result' => '短期間・低コストでリリースし、運用工数を削減',
			'is_placeholder' => false,
			'detail' => array(
				array( 'h' => '背景・ご相談内容', 't' => '「予約を紙と電話で管理していて、ダブルブッキングや確認漏れが起きていた。アプリ化したいが費用が不安」とのご相談でした。' ),
				array( 'h' => '課題', 't' => '限られた予算とスピード感の中で、現場が無理なく使える予約管理の仕組みが必要でした。' ),
				array( 'h' => 'アイズの支援内容', 't' => 'APPREXのノーコード開発で要件を整理し、予約管理アプリを開発・リリース。公開後の改善にも対応しました。' ),
				array( 'h' => '成果', 't' => '短期間・低コストでリリース。予約状況をアプリで一元管理でき、確認の手間と入力ミスを削減しました。' ),
			),
		),
		array(
			'slug' => 'webcrews-corporate-site', 'category' => 'it', 'category_label' => 'WEB制作（WEB crews）',
			'title' => 'サブスク型で初期費用を抑え、コーポレートサイトを公開',
			'summary' => '初期費用をかけずにWebサイトを持ちたい事業者様へ、サブスクWeb制作「WEB crews」で制作。公開後の更新まで月額に含めて対応しています。',
			'result' => '初期費用を抑えて公開、更新も任せて運用負担を軽減',
			'is_placeholder' => false,
			'detail' => array(
				array( 'h' => '背景・ご相談内容', 't' => '「ホームページを作りたいが、まとまった初期費用は厳しい。更新も自分たちでは難しい」とのご要望でした。' ),
				array( 'h' => '課題', 't' => '初期コストを抑えつつ、公開後も継続的に更新・改善できる体制が必要でした。' ),
				array( 'h' => 'アイズの支援内容', 't' => 'WEB crewsのサブスク型で制作。初期費用を抑え、公開後の更新・運用も月額に含めて継続対応しています。' ),
				array( 'h' => '成果', 't' => 'まとまった初期投資なくサイトを公開。更新を任せられることで、本業に集中できる環境が整いました。' ),
			),
		),
		array(
			'slug' => 'fc-new-opening', 'category' => 'business', 'category_label' => 'FC事業',
			'title' => 'カーメル／BUYMO の FC 加盟で、自動車事業へ新規参入',
			'summary' => '異業種から自動車事業への参入をお考えの事業者様が、カーメル／BUYMOのフランチャイズに加盟。開業準備から運営まで本部が伴走しました。',
			'result' => '開業準備から運営までを伴走し、スムーズに開業',
			'is_placeholder' => false,
			'detail' => array(
				array( 'h' => '背景・ご相談内容', 't' => '「自動車の販売・買取に新規参入したいが、ノウハウがなく不安」と、FC加盟のご相談をいただきました。' ),
				array( 'h' => '課題', 't' => '未経験の分野での開業にあたり、仕入れ・販売・買取の仕組みと運営ノウハウの習得が課題でした。' ),
				array( 'h' => 'アイズの支援内容', 't' => 'カーメル／BUYMOのFCスキームを提供。開業準備・研修から、開業後の運営まで本部がサポートしました。' ),
				array( 'h' => '成果', 't' => 'ブランドと仕組みを活用し、ゼロからの立ち上げよりもスムーズに開業。販売と買取の両輪で事業を開始できました。' ),
			),
		),
	);
}
