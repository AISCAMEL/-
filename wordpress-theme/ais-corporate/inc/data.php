...
function ais_representative() {
	...
	return array(
		...
		'body'    => array(
			...
			'私たちは「Always Innovation Solutions（常に、新しい解決策を）」を掲げ、自動車事業を主軸に、IT・WEB事業、FC事業まで幅広く手がけています。クルマの販売・買取・オンライン納車・セキュリティ・レッカーから、アプリ・Web制作まで——お客様の「困った」「こうしたい」に、ワンストップでお応えすることを大切にしています。',
			'とりわけ自動車業界は、クルマの「買い方」も「持ち方」も大きく変わろうとしています。私たちはその変化を「リスク」ではなく「成長の機会」と捉え、新しい仕組みを積極的に取り入れながら、いわきの地から地域とお客様に寄り添い続けます。',
			'お渡しして終わりにはしません。構想から実行、そしてその先の成果まで——最後まで伴走するパートナーでありたいと考えています。ご相談は、お問い合わせフォーム・メール・このサイトのAIチャットから、どうぞお気軽に。',
		),
	);
}
