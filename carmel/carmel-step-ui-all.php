 ...
 * 機能: 見積初期費用設定 / STEP1-2(基本+装備全連動+タイトル) / STEP3見積計算 /
 *       支払回数(昇順120回) / STEP4担当店舗 / 画面整理 / [carmel_equipment] /
 *       金額コンマ自動化 / ギャラリー1枚目→アイキャッチ自動
 * 導入: WPCode PHP Snippet（Run Everywhere）。ACFは2グループをインポート。
 */
