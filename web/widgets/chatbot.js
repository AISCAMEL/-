...
(function(){
  ...
  +'.bmc-l .t{background:#fff;color:'+NAVY+';font-weight:800;font-size:12.5px;padding:7px 12px;border-radius:14px 14px 2px 14px;box-shadow:0 8px 20px -8px rgba(0,0,0,.3);font-family:"Noto Sans JP",sans-serif}'
  +'@keyframes bmcbob{50%{transform:translateY(-5px)}} .bmc-l .b{animation:bmcbob 2.6s ease-in-out infinite}'
  +'.bmc-p{position:fixed;right:18px;bottom:18px;z-index:10000;width:360px;max-width:calc(100vw - 24px);height:560px;max-height:calc(100vh - 36px);background:#fff;border-radius:18px;box-shadow:0 30px 70px -20px rgba(0,0,0,.45);display:none;flex-direction:column;overflow:hidden;font-family:"Noto Sans JP",sans-serif}'
