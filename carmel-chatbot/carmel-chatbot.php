...
define( 'CARMEL_CB_VERSION', '1.88.0' );
...
require_once CARMEL_CB_PATH . 'includes/apply-followup.php';
require_once CARMEL_CB_PATH . 'includes/convo-followup.php';
require_once CARMEL_CB_PATH . 'includes/notify.php';
require_once CARMEL_CB_PATH . 'includes/campaign.php';
require_once CARMEL_CB_PATH . 'includes/shinsa.php';
...
function carmel_cb_deactivate() {
	...
	wp_clear_scheduled_hook( 'carmel_cb_apply_followup_tick' );
}
