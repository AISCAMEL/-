...
export const metadata: Metadata = {
  title: "お問い合わせ・無料相談",
  description:
    "合同会社アイズへのお問い合わせ。自動車業界支援・創業支援・Web/開発のご相談を承ります。初回相談・お見積りは無料。法人・個人事業主どちらも対応、原則1〜2営業日以内にご返信します。",
  alternates: { canonical: "/contact" },
};

const examples = [
  "自動車販売に新規参入したいので、進め方を相談したい",
  "DXを進めたいが、何から始めればいいか整理してほしい",
  "サイトをリニューアルして問い合わせを増やしたい",
  "創業にあたり、資金調達や補助金について相談したい",
  "業務システムやアプリの開発を相談したい",
];
          ...
          <div className="lg:col-span-5">
            ...
            <ul className="mt-5 space-y-3">
              {[
                ...
                ["法人・個人事業主どちらもOK", "これから起業される個人の方も歓迎です。"],
